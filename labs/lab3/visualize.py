...
targets = [
    ...
    transform( np.array([0.2, 0.6, 0.5]), np.array([0,pi-pi/2,pi])),
    transform( np.array([.2, .6, 0.5]),  np.array([0,pi,pi])            ),
    transform( np.array([-.2, -.3, .5]), np.array([pi/6,5/6*pi,7/6*pi])            ),
    transform( np.array([-.2, .3, .5]),  np.array([0,pi,pi]) ),
    transform( np.array([.5, 0, .5]),    np.array([pi/2,pi-pi/2,pi])            ),
    transform( np.array([.2, .6, 0.5]),  np.array([0,pi,pi-pi/2])            ),
    transform( np.array([.2, .6, 0.5]),  np.array([0,pi-pi/2,pi])       ),
    transform( np.array([.2, -.6, 0.5]), np.array([pi/4,pi-pi/2,pi])       ),
    transform( np.array([.2, -.6, 0.5]), np.array([0,pi-pi/2,pi])    ),
    transform( np.array([.4, 0, 0.2]),   np.array([0,pi,pi])    ),
...
times_max = np.amax(times)
iterations_max = np.amax(iterations)
print("Mean time: ", times_mean)
print("Median time: ", times_median)
print("Max time: ", times_max)
print("Iteration mean: ", iterations_mean)
print("Iteration median: ", iterations_median)
print("Iteration max: ", iterations_max)
print("Rate of success: ", rate_success, "/10")
