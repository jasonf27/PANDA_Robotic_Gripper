...
if __name__ == "__main__":
    ...
    # order the list of transformations of the static blocks in the robot frame
    # from closest to the robot base to farthest
    Trobot_block_ordered_list = getOrderedBlocks(Trobot_block_list)
    # print("Trobot_block_ordered_list = ", Trobot_block_ordered_list)
