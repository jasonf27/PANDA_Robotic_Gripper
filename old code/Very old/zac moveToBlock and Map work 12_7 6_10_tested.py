...
if __name__ == "__main__":
    ...
    world_map = open("../../maps/emptyMap.txt")
    current_map = world_map.readlines()
    world_map.close()

    current_map.append("block 0.15 -0.300 0.496825  0.45 0.300 0.503175\n")
    new_map = "".join(current_map)

    world_map = open("../../maps/emptyMap.txt","w")
    world_map.write(new_map)
    world_map = open("../../maps/emptyMap.txt")
    content = world_map.read()
    world_map.close()
    print(content)
